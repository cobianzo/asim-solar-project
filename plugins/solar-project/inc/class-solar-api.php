...
class Solar_API {
	 ...
	 * @return mixed
	 */
	public static function get_google_api_response( string $base_url, string $method, array $data = array() ) {
	 ...
	 * @return mixed
	 */
	public static function get_solar_api_response( string $method, array $data = array() ) {
		return self::get_google_api_response( self::$base_solar_endpoint, $method, $data );
	}
	public static function get_maps_api_response( string $method, array $data = array() ) {
	...
	public static function get_solar_building_data( $latitude, $longitude ) {
		return self::get_solar_api_response( 'buildingInsights:findClosest', array(
	...
	public static function get_maps_building_data( $latitude, $longitude ) {
		return self::get_maps_api_response( 'geocode/json', array(
	...
	public static function get_datalayer_urls( $latitude, $longitude, $extra_params = array() ) {
